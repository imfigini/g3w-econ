...
class pagelet_edicion_asistencias extends pagelet
{
	...
	protected function get_clase_encabezado()
	{
		return $this->controlador->get_clase_encabezado();
	}
    ...
    function prepare()
    {
		...
		$this->data['comision'] = $this->controlador->comision_id;
