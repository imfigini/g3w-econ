<?php
namespace econ\operaciones\asignacion_mat_prom_dir\filtro;
...
class builder_form_filtro extends builder_formulario
{
	...
	function get_action() 
	{
		return kernel::vinculador()->crear('asignacion_mat_prom_dir', 'index');
	}
	...
	{
            return array(""=>  kernel::traductor()->trans('asignacion_mat_prom_dir.filtro_seleccione'));
	}
}
